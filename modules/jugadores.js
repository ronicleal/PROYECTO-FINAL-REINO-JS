...
export class Jugador {
    ...
    */
    ...
    /**
    * Calcula el total de ataque del jugador basado en los bonus de sus ítems de tipo 'Arma'.
    ...
    */
    ...
    /**
    * Getter de Defensa Total (basado en items de tipo 'Armadura')
    ...
    */
    ...
    /**
    * Getter de Vida Total (basado en items de tipo 'Consumible' que dan vida)
    * @returns {number} Puntos de vida máxima totales.
    */
    get vidaTotal() {
